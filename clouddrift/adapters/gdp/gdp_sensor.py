...
_TMP_PATH = os.path.join(tempfile.gettempdir(), "clouddrift", "gdp_sensor")
_FILENAME_TEMPLATE = "buoydata_{start}_{end}_{suffix}.dat.gz"
_SECONDS_IN_DAY = 86_400

_COORDS = ["id", "obs_index"]

# from header_buoydata_edited_sfiles.txt
# ID,Position Time(MM,DD.dd,YYYY),Drogue,SST,Voltage,Sensor4,Sensor5,Sensor6
_DATA_VARS = [
    "sensor_datetime",
    "drogue",
    "sst",
...
ATTRS = {
    "title": "Global Drifter Program edited s-files dataset",
    "Conventions": "CF-1.6",
    ...
    "processing_level": "edited s-files",
    "metadata_link": "https://www.aoml.noaa.gov/phod/dac/dirall.html",
    "contributor_name": "NOAA Global Drifter Program",
    "contributor_role": "Data Acquisition Center",
    "institution": "NOAA Atlantic Oceanographic and Meteorological Laboratory",
    "summary": "Global Drifter Program sensor data",
}
...
def _process_chunk(
    ...
    preremove_df_chunk["senObsYear_numeric"] = pd.to_numeric(
        preremove_df_chunk["senObsYear"], errors="coerce"
    )
...
def to_raggedarray(
    ...
    """
    Convert GDP source sensor data into a ragged array format and return it as an xarray Dataset.
